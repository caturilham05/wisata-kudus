			...
			<nav class="navbar navbar-expand-sm navbar-light">
				...
				<div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
					<ul class="navbar-nav">
						...
						<!-- <li class="nav-item "><a class="nav-link" href="<?= base_url('C_mudik/form'); ?>">Form Pemudik</a></li> -->
					...
					<div class="rounded-15 shadow bg-white">
						<div class="carda" style="padding: 15px;">
							<div class="card-body">
								...
								<form action="<?= base_url('C_mudik/tambah'); ?>" method="post" id="myForm" onSubmit="return validasi(this)">
									<div class="form-row">
										...
										<div class="form-group col-12">
											...
											<input type="number" class="form-control" name="nik" placeholder="No Induk Kependudukan/ No KTP" onkeypress="return hanyaAngka(event)" id="nik" maxlength="16" autocomplete="off" required required style="background-color: #eee">
											<div class="form_error"><?php echo validation_errors(); ?> </div>
										</div>

										<div class="form-group col-12">
											<label for="fm-nama">Nama</label>
											<input type="text" class="form-control" id="fm-nama" placeholder="Nama Lengkap" name="nama" autocomplete="off" readonly >
										</div>

										<div class="form-group col-6">
											<label for="fm-tgl-lahir">Tanggal Lahir</label>
											<input type="text" class="form-control readonly" id="fm-tgl-lahir" placeholder="dd/mm/yyyy" name="tanggal_lahir" autocomplete="off" required style="background-color: #eee">
										</div>

										<!-- <div class="form-group col-6">
											<label for="fm-tgl-lahir">Umur</label>
											<input type="text" class="form-control" autocomplete="off" id="umur" placeholder="Umur Anda" name="umur" readonly>
                                        </div> -->
                                        
                                        <div class="form-group col-6">
											<label for="fm-tgl-lahir">Jenis Kelamin</label>
											<input type="text" class="form-control readonly"  placeholder="Jenis Kelamin" name="jenis_kelamin" autocomplete="off" required  style="background-color: #eee">
										</div>
										...
										<div class="form-group col-12 col-sm-6">
											...
											<input type="date" class="form-control datepicker" autocomplete="off" id="fm-estimasi-sampai" placeholder="dd/mm/yyyy" data-toggle="datetimepickerw" data-target="#fm-estimasi-sampaie" name="estimasisampai" value="" required>
										</div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
             ...
             $('#nik').on('input',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('C_mudik/tampil_otomatis')?>",
                    dataType : "JSON",
                    data : {nik: nik},
                    cache:false,
						success: function(data){
							$('[name="nama"]').val(data.content[0].NAMA_LGKP);
                            $('[name="tanggal_lahir"]').val(data.content[0].TGL_LHR);
                            $('[name="jenis_kelamin"]').val(data.content[0].JENIS_KLMIN);
						}
                });
                return false;
           });
