...
<head>
  ...
  <meta name="description" content="mudik pemkab kudus">

  <meta name="keywords" content="mudik pemkab kudus">
      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
       ...
       <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
        <ul class="navbar-nav" >
            ...
            <!-- <li class="nav-item ">
              <a class="nav-link" href="<?= base_url('C_mudik/form'); ?>">Form wisata</a>
            </li> -->
            <li class="nav-item ">
              <a class="nav-link" href="<?= base_url('C_mudik/list'); ?>">Terdaftar</a>
            </li>
          </ul>
       </div>
    </nav>
            ...
            <div class="row justify-content-center">
             ...
             <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10 col-sm-10 mb-lg-5">         
                 ...
                 <h1 style="padding-left:10%; margin-top: 20%;margin-bottom:-3px;"><b>DATA WISATAWAN</b></h1>
               ...
               <div class="col-lg-6 col-md-10 col-sm-10">
                      <h4 style="padding-left:10%;margin-top:40px;"><b>APA SAJA YANG DIBUTUHKAN?</b></h4>
                      <ol style="text-align: justify; padding-left:15%; ">
                        <li>Klik link Isi Form Data Tujuan Wisata</li>
                      </ol>
                     <h4 style="padding-left:10%;"><b>PETUNJUK PENGISIAN : </b></h4>
                     <ol style="text-align: justify; padding-left:15%; padding-right:50px; " >
                      <li>Isikan Data diri Anda yakni Nama Lengkap, Tanggal Lahir, dan Nomor Handphone / WhatsApp yang aktif.</li>
                      <!-- <li>Pilih negara asal. Ketik nama negara, jika Anda bukan dari luar negeri, ketik INDONESIA</li> -->
                      <li>Ketik kota/ kabupaten asal</li>
                      <li>Isi pertanyaan-pertanyaan yang disediakan (wajib diisi semua)</li>
                      <li>Pastikan seluruh pertanyaan telah diisi dan dijawab dengan sebenar-benarnya</li>
                      <li>Jika selesai, klik Setuju dan Simpan</li>
                    </ol>
                    
                </div>
                    <div class="col-md-10 col-sm-10 offset-md-1  mb-5">
                      <!-- <div class="btn-group">
                        <a href="<?//php echo base_url('C_mudik/formA'); ?>" class="btn third">Form wisata KTP KUDUS</a> 
                      </div> -->
                      <div class="btn-group">
                        <a href="<?php echo base_url('C_mudik/form'); ?>" class="btn third">Form wisata KTP PENDATANG</a> 
                      </div>
                  </div>
