...
<html lang="id">
    <head>
        ...
        <link href="<?=base_url();?>plato/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link rel="stylesheet" href="<?=base_url();?>plato/assets/css/animate.css">
    </head>
    <body>
        <div class="error-container">
            <div class="error-content bounceIn animated">
                <img width="100%" src="<?=base_url();?>plato/assets/img/error.jpg">
                <p class="error-text">
